...
kmap('n', '<leader>lr', vim.lsp.buf.rename, { desc = 'Rename' })
kmap('n', '<leader>la', vim.lsp.buf.code_action, { desc = 'Code Action' })
kmap('n', 'gd', vim.lsp.buf.definition, { desc = 'Goto Definition' })
kmap('n', 'gr', function() MiniExtra.pickers.lsp({ scope = 'references' }) end, { desc = 'Goto References' })
kmap('n', 'gI', vim.lsp.buf.implementation, { desc = 'Goto Implementation' })
kmap('n', 'gt', vim.lsp.buf.type_definition, { desc = 'Goto Type Definition' })
kmap('n', 'K', vim.lsp.buf.hover, { desc = 'Hover Documentation' })
kmap('n', '<leader>k', vim.lsp.buf.signature_help, { desc = 'Signature Documentation' })
kmap('n', 'gD', vim.lsp.buf.declaration, { desc = 'Goto Declaration' })
kmap('n', '<leader>lF', vim.lsp.buf.format, { desc = 'Format' })
kmap('n', '<leader>wa', vim.lsp.buf.add_workspace_folder, { desc = 'Add Workspace' })
kmap('n', '<leader>wr', vim.lsp.buf.remove_workspace_folder, { desc = 'Remove Workspace' })
kmap(
  'n',
  '<leader>wl',

...
vim.keymap.set('n', 'gn', ":bn<CR>", { desc = '[B]uffer [N]ext' })
vim.keymap.set('n', 'gp', ":bp<CR>", { desc = '[B]uffer [P]rev' })
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'sql', 'scala',
    'html', 'css', 'markdown', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim' },
